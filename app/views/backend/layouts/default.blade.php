					...
					<div class="container">
						...
						<div class="nav-collapse collapse">
							<ul class="nav">
								...
								<li{{ (Request::is('admin/wants*') ? ' class="active"' : '') }}><a href="{{ URL::to('admin/wants') }}"><i class="icon-list-alt icon-white"></i> I want</a></li>
								<li{{ (Request::is('admin/cans*') ? ' class="active"' : '') }}><a href="{{ URL::to('admin/cans') }}"><i class="icon-list-alt icon-white"></i> I can</a></li>
